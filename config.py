...
DISCORD_BOT_TOKEN = get_optional_env("DISCORD_BOT_TOKEN")
DISCORD_CHANNEL_ID = get_optional_env("DISCORD_CHANNEL_ID")
DISCORD_INTERACTIVE_SL_TP = get_optional_bool_env("DISCORD_INTERACTIVE_SL_TP", False)
DISCORD_APPROVAL_TIMEOUT_SECONDS = int(os.getenv("DISCORD_APPROVAL_TIMEOUT_SECONDS", "60"))
...
POSITION_TAKE_PROFIT_PERCENT = get_required_float_env("POSITION_TAKE_PROFIT_PERCENT")
POSITION_STOP_LOSS_PERCENT = get_required_float_env("POSITION_STOP_LOSS_PERCENT")
POSITION_MONITOR_INTERVAL_SECONDS = get_required_int_env("POSITION_MONITOR_INTERVAL_SECONDS")
QUOTE_FRESHNESS_SECONDS = get_required_int_env("QUOTE_FRESHNESS_SECONDS")
POSITION_MONITOR_HOLD_FOR_SETTLEMENT = get_optional_bool_env("POSITION_MONITOR_HOLD_FOR_SETTLEMENT", False)
POSITION_MONITOR_SETTLEMENT_HOLD_SECONDS = get_required_int_env("POSITION_MONITOR_SETTLEMENT_HOLD_SECONDS") if os.getenv("POSITION_MONITOR_SETTLEMENT_HOLD_SECONDS") else 3600
...
print(f"[CONFIG] POSITION_TAKE_PROFIT_PERCENT: {POSITION_TAKE_PROFIT_PERCENT}")
print(f"[CONFIG] POSITION_STOP_LOSS_PERCENT: {POSITION_STOP_LOSS_PERCENT}")
print(f"[CONFIG] POSITION_MONITOR_INTERVAL_SECONDS: {POSITION_MONITOR_INTERVAL_SECONDS}")
print(f"[CONFIG] QUOTE_FRESHNESS_SECONDS: {QUOTE_FRESHNESS_SECONDS}")
print(f"[CONFIG] POSITION_MONITOR_HOLD_FOR_SETTLEMENT: {POSITION_MONITOR_HOLD_FOR_SETTLEMENT}")
print(f"[CONFIG] POSITION_MONITOR_SETTLEMENT_HOLD_SECONDS: {POSITION_MONITOR_SETTLEMENT_HOLD_SECONDS}")